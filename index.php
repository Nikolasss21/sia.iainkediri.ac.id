...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <!--[if lt IE 9]>
                  <script src="/siakad/assets/v1/js/external/html5shiv.js"></script>
          <script src="/siakad/assets/v1/js/external/respond.min.js"></script>
          <![endif]-->
...
<body class="login-page" action ="process.php" style="">
    <form id="login_form" action="process.php" method="post" novalidate="1" onsubmit="return window.Event &amp;&amp; Event.__inlineSubmit &amp;&amp; Event.__inlineSubmit(this,event)">
    <div class="container">
        <div class="row">
